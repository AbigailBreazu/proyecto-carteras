...
export default function ProductosAdminPage() {
  ...
  const stats = {
    ...
    carteras: productos.filter(p => (p.tipo || p.categoria) === 'cartera').length,
    rinoneras: productos.filter(p => (p.tipo || p.categoria) === 'rinonera').length,
    materas: productos.filter(p => (p.tipo || p.categoria) === 'matera').length,
    combos: productos.filter(p => (p.tipo || p.categoria) === 'combo').length,
    mochilas: productos.filter(p => (p.tipo || p.categoria) === 'mochila').length,
    neceser_pileta: productos.filter(p => (p.tipo || p.categoria) === 'neceser_pileta').length,
    neceser_higiene: productos.filter(p => (p.tipo || p.categoria) === 'neceser_higiene').length,
    mantel_camping: productos.filter(p => (p.tipo || p.categoria) === 'mantel_camping').length,
    bolso_camping: productos.filter(p => (p.tipo || p.categoria) === 'bolso_camping').length,
    lonchera_termica: productos.filter(p => (p.tipo || p.categoria) === 'lonchera_termica').length,
